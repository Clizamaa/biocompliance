...
import { ArrowLeft, Search, Wind, Trash2, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import MinsalModal from '@/components/ui/MinsalModal';

const asbestoServices = [
  { title: 'Plan de Manejo de Asbesto', icon: <Search className="h-6 w-6 text-red-600" /> },
];

export default function AsbestoPage() {
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-charcoal-800 mb-4">Plan Nacional para la Erradicación del Asbesto</h1>
              <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                Ofrecemos soluciones integrales para la gestión y erradicación del asbesto, garantizando la seguridad y el cumplimiento normativo.
              </p>
            </div>
            
            <div className="flex justify-center">
              <div className="flex flex-wrap justify-center gap-8">
                {asbestoServices.map((service, index) => (
                  <FadeIn key={index}>
