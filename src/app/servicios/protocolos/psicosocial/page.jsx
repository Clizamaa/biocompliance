...
import { ArrowLeft, FileQuestion, BarChart3, Users, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import MinsalModal from '@/components/ui/MinsalModal';

const psicosocialServices = [
  { title: 'Protocolo de Riesgos Psicosociales CEAL-SM/SUSESO', icon: <FileQuestion className="h-6 w-6 text-green-600" /> },
  { title: 'Implementación Protocolo Riesgos Psicosociales CEAL-SM/SUSESO', icon: <BarChart3 className="h-6 w-6 text-green-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              <Badge className="bg-green-100 text-green-800 mb-4">Protocolo MINSAL</Badge>
              <h1 className="text-3xl lg:text-4xl font-bold text-charcoal-800 mb-4">Protocolo de Vigilancia de Riesgos Psicosociales en el Trabajo</h1>
              <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                Medimos y gestionamos los riesgos psicosociales en su organización para fomentar un ambiente de trabajo saludable y cumplir con la normativa.
              </p>
            </div>
            
            <div className="flex justify-center">
              <div className="flex flex-wrap justify-center gap-8">
                {psicosocialServices.map((service, index) => (
                  <FadeIn key={index}>
