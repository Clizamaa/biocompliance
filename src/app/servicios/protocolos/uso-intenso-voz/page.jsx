...
import { ArrowLeft, Mic, Volume2, Users, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import MinsalModal from '@/components/ui/MinsalModal';

const vozServices = [
  { title: 'Protocolo de Vigilancia de Trabajadores Expuestos a Uso Intenso de la Voz', icon: <Mic className="h-6 w-6 text-indigo-600" /> },
  { title: 'Implementación Protocolo Uso Intenso de la Voz', icon: <Volume2 className="h-6 w-6 text-indigo-600" /> },
];

export default function UsoIntensoVozPage() {
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              <Badge className="bg-indigo-100 text-indigo-800 mb-4">Protocolo MINSAL</Badge>
              <h1 className="text-3xl lg:text-4xl font-bold text-charcoal-800 mb-4">Protocolo de Vigilancia para Trabajadores Expuestos a Uso Intenso de la Voz</h1>
              <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                Protegemos la salud vocal de los trabajadores que utilizan intensamente su voz, cumpliendo con los protocolos de vigilancia MINSAL.
              </p>
            </div>
            
            <div className="flex justify-center">
              <div className="flex flex-wrap justify-center gap-8">
                {vozServices.map((service, index) => (
                  <FadeIn key={index}>
                    <Card className="border border-slate-200 shadow-lg h-full text-center max-w-sm mx-auto">
                      <CardHeader className="pb-4 pt-6">
                        ...
                        <CardTitle className="text-lg font-bold text-charcoal-700">{service.title}</CardTitle>
                      </CardHeader>
                    </Card>
                  </FadeIn>
                ))}
            ...
            <div className="mt-16 text-center">
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                >
                  ...
                  Ver todos los protocolos MINSAL
                </Button>
                <Link href="/#contacto">
