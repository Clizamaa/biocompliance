...
import { ArrowLeft, Mic, Volume2, MessageSquare } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import MinsalModal from '@/components/ui/MinsalModal';

const vozServices = [
  { title: 'Protocolo Vigilancia Uso Intensivo de la Voz', icon: <Mic className="h-6 w-6 text-teal-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-16">
              <Badge className="bg-teal-100 text-teal-800 mb-4">Protocolo MINSAL</Badge>
              <h1 className="text-3xl lg:text-4xl font-bold text-charcoal-800 mb-4">Protocolo de Vigilancia para Trabajadores con Exposición a Voz</h1>
              <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                Cuidamos la salud vocal de tus trabajadores, implementando programas de vigilancia y control de riesgos para profesionales de la voz.
              </p>
            </div>
