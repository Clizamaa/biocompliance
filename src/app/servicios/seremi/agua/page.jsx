...
import { ArrowLeft, ArrowRight, ChevronDown, Landmark, Waves, Droplet, CheckCircle, FileText, Users, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import ServiceModal from '@/components/ui/ServiceModal';

// Dummy data for water services
const waterServices = [
  { title: 'Gestión de Aprobación de proyecto de sistemas de tratamiento de residuos industriales líquidos', icon: <Droplet className="h-6 w-6 text-blue-600" /> },
  { title: 'Gestión de Autorización de funcionamiento de sistemas de tratamiento de residuos industriales líquidos', icon: <Waves className="h-6 w-6 text-blue-600" /> }, 
];
...
export default function AguaPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header - Assuming a similar header structure */}
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              ...
              <div className="text-center mb-16">
                <Badge className="bg-blue-100 text-blue-800 mb-4">Servicios de Agua</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Trámites y Autorizaciones de Agua</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Ofrecemos un completo soporte para la gestión de todos los trámites relacionados con recursos hídricos ante la Seremi de Salud.
                </p>
              </div>
