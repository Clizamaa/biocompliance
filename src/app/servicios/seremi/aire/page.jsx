...
const airServices = [
  { title: 'Declaración de emisiones atmosféricas: declaración anual de las emisiones generadas conforme a las metodologías definidas en el Decreto Supremo 138/05. ', icon: <Wind className="h-6 w-6 text-gray-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-gray-100 text-gray-800 mb-4">Servicios de Aire</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Trámites y Autorizaciones de Aire</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Soporte completo para la gestión de trámites relacionados con la calidad del aire y emisiones atmosféricas.
                </p>
              </div>
