...
// Dummy data for asbestos services
const asbestosServices = [
  { title: 'Autorización de un plan de trabajo y disposición final de materiales con asbesto (MCA).', icon: <AlertTriangle className="h-6 w-6 text-red-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-red-100 text-red-800 mb-4">Servicios de Asbesto</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Trámites y Autorizaciones de Asbesto</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Gestión de planes de trabajo y autorizaciones para el manejo seguro de materiales con asbesto.
                </p>
              </div>
