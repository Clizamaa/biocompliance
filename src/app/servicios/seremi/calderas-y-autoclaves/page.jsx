...
import { ArrowLeft, Flame, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import ServiceModal from '@/components/ui/ServiceModal';

// Dummy data for boiler and autoclave services
const boilerServices = [
  { title: 'Solicitud de número de registro a calderas y autoclaves', icon: <Flame className="h-6 w-6 text-orange-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-orange-100 text-orange-800 mb-4">Servicios de Calderas y Autoclaves</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Trámites de Calderas y Autoclaves</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Asesoría para la autorización e inspección de calderas, autoclaves y equipos generadores de vapor.
                </p>
              </div>
