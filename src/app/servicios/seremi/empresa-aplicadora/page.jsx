...
import { ArrowLeft, SprayCan, Bug, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import ServiceModal from '@/components/ui/ServiceModal';

// Dummy data for applicator company services
const applicatorServices = [
  { title: 'Autorización de empresa aplicadora de fumigantes y/o plaguicidas de uso sanitario y doméstico', icon: <SprayCan className="h-6 w-6 text-green-600" /> },
  { title: 'Cambio/incorporación de responsable técnico de empresas aplicadoras de pesticidas de uso sanitario y doméstico', icon: <Bug className="h-6 w-6 text-green-600" /> }, 
];

export default function EmpresaAplicadoraPage() {
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-green-100 text-green-800 mb-4">Empresa Aplicadora</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Autorizaciones para Empresas Aplicadoras</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Soporte para la obtención y renovación de autorizaciones sanitarias para empresas aplicadoras de plaguicidas y desinfectantes.
                </p>
              </div>
            
            <div className="flex justify-center">
              <div className="grid md:grid-cols-2 gap-8">
              {applicatorServices.map((service, index) => (
                <FadeIn key={index}>
