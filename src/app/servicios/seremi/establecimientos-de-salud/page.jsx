...
import { ArrowLeft, Scissors, HeartPulse, Stethoscope, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import ServiceModal from '@/components/ui/ServiceModal';

// Dummy data for health establishment services
const healthServices = [
  { title: 'Autorización de instalación y funcionamiento de pabellón de cirugía menor y salas de procedimiento', icon: <Scissors className="h-6 w-6 text-teal-600" /> },
  { title: 'Gestión de la Notificación disponibilidad de equipos DEA (Desfibrilador Externo Automático Portátil)', icon: <HeartPulse className="h-6 w-6 text-teal-600" /> },
  { title: 'Gestión de Autorización de Establecimientos de Salud capacitadores para el uso de equipos DEA (Desfibrilador Externo Automático Portátil)', icon: <Stethoscope className="h-6 w-6 text-teal-600" /> },
];
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-teal-100 text-teal-800 mb-4">Establecimientos de Salud</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Autorizaciones para Establecimientos de Salud</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Asesoría integral para la obtención y modificación de autorizaciones sanitarias para establecimientos de salud.
                </p>
              </div>
                ...
                <FadeIn key={index}>
                  <Card className="border border-slateGray-200 shadow-lg h-full text-center max-w-sm mx-auto">
                    <CardHeader className="pb-2">
                      <div className="h-12 w-12 rounded-full bg-teal-100 flex items-center justify-center mb-4 mx-auto">
                        {service.icon}
                      </div>
