...
import { ArrowLeft, Radiation, Truck, Archive, Menu, X } from 'lucide-react';
...
export default function RadiacionPage() {
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-yellow-100 text-yellow-800 mb-4">Radiación</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Protección y Control de Radiaciones</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Asesoría para la obtención de autorizaciones y licencias para el manejo de fuentes de radiación ionizante.
                </p>
              </div>
            
            <div className="flex justify-center">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {radiationServices.map((service, index) => (
                <FadeIn key={index}>
