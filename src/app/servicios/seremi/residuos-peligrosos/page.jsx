...
import { ArrowLeft, Biohazard, ClipboardCheck, Truck, Archive, FileCheck, Menu, X } from 'lucide-react';
import Image from "next/image";
import Link from "next/link";
import ServiceModal from '@/components/ui/ServiceModal';

// Dummy data for hazardous waste services
const hazardousWasteServices = [
  { title: 'Aprobación del programa de eliminación de envases de plaguicidas sometidos a triple lavado', icon: <ClipboardCheck className="h-6 w-6 text-red-600" /> },
  { title: 'Autorización para el transporte de residuos peligrosos', icon: <Truck className="h-6 w-6 text-red-600" /> },
  { title: 'Autorización de funcionamiento del sitio de almacenamiento de residuos peligrosos', icon: <Archive className="h-6 w-6 text-red-600" /> },
  { title: 'Aprobación de plan de manejo residuos peligrosos', icon: <ClipboardCheck className="h-6 w-6 text-red-600" /> },
  { title: 'Aprobación de proyecto del sitio de almacenamiento de residuos peligrosos', icon: <FileCheck className="h-6 w-6 text-red-600" /> },
  { title: 'Autorización de la instalación de almacenamiento de residuos peligrosos por períodos prolongados', icon: <Archive className="h-6 w-6 text-red-600" /> },
  { title: 'Aprobación de proyecto de instalación de almacenamiento de residuos peligrosos por períodos prolongados', icon: <FileCheck className="h-6 w-6 text-red-600" /> },
];

export default function ResiduosPeligrososPage() {
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-16">
                <Badge className="bg-red-100 text-red-800 mb-4">Residuos Peligrosos</Badge>
                <h1 className="text-3xl lg:text-4xl font-bold text-black-800 mb-4">Gestión de Residuos Peligrosos (RESPEL)</h1>
                <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                  Asesoría integral en la declaración, manejo, transporte y disposición final de residuos peligrosos (RESPEL).
                </p>
              </div>
