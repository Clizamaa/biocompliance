...
export default function DjaPage() {
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
              ...
              <div className="bg-gradient-to-r from-robinEggBlue-50 to-robinEggBlue-100 rounded-lg p-6 mb-8">
                <p className="text-lg leading-relaxed text-gray-800">
                  Informe obligatorio que deben presentar las empresas reguladas, incluyendo datos sobre emisiones, residuos, cumplimiento ambiental y otras variables.
                </p>
              </div>
            </div>
          </FadeIn>
