...
export default function RilesPage() {
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
              ...
              <div className="bg-gradient-to-r from-robinEggBlue-50 to-robinEggBlue-100 rounded-lg p-6 mb-8">
                <p className="text-lg leading-relaxed text-gray-800">
                  Plataforma para declarar y controlar las descargas líquidas industriales hacia cuerpos de agua o alcantarillado, verificando su cumplimiento ambiental.
                </p>
              </div>
            </div>
          </FadeIn>
