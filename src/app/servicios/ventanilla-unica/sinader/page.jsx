...
export default function SinaderPage() {
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
              ...
              <div className="bg-gradient-to-r from-robinEggBlue-50 to-robinEggBlue-100 rounded-lg p-6 mb-8">
                <p className="text-lg leading-relaxed text-gray-800">
                  Plataforma para declarar todo tipo de residuos (no solo peligrosos), promoviendo la gestión integral y la economía circular a través del monitoreo de su origen y destino.
                </p>
              </div>
            </div>
          </FadeIn>
