          ...
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slateGray-600 max-w-3xl mx-auto">
                Sistema de Información de Seguimiento de Aguas Terrestres
              </p>
            </div>
          </FadeIn>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
              ...
              <div className="bg-gradient-to-r from-robinEggBlue-50 to-robinEggBlue-100 rounded-lg p-6 mb-8">
                <p className="text-lg leading-relaxed text-gray-800">
                  Monitorea en línea las emisiones de contaminantes atmosféricos de fuentes industriales sujetas a Planes de Descontaminación o Normas de Emisión.
                </p>
              </div>
            </div>
          </FadeIn>
